...
const ScrollSnapSlider = () => {
  ...
  return (
    ...
    <ul className="hs full">
       ...
       {cat1.map((c,index)=>( 
        <article className="item p-1 rounded-xl bg-white ring-3 ring-indigo-50 sm:p-1 lg:p-4 gapx-3" style={{minHeight:'200px', maxHeight:'50vh',width:'auto',minWidth:'200px',maxWidth:'270px',minHeight:'22em',margin:'auto',border:'2px solid rgba(0,0,0,0.12)'}}>
